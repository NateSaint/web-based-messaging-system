...
struct PostEntry {
	void (*PostEntryreadUserInputc) ();

	char * (*PostEntrygetTimeDate) ();

	void (*PostEntryformatEntryccc) ();
...
void constructorPostEntry(struct PostEntry *x)
{
    x->PostEntryreadUserInputc = PostEntryreadUserInputc;
    x->PostEntrygetTimeDate = PostEntrygetTimeDate;
    x->PostEntryformatEntryccc = PostEntryformatEntryccc;
    x->PostEntrysubmitPost = PostEntrysubmitPost;
}
...
constructorPostEntry(&post);
	...
	post.PostEntryreadUserInputc(username);
